...
export const metadata: Metadata = {
  title: "ACE Geofence - Terms of Use",
  description: "ACE Geofence All in one SmartHR Service - Terms of Use",
};
    ...
    <div className="px-6 lg:px-12 xl:px-24">
      ...
      <div className="space-y-4">
        <p className="text-wrap">
          ...
          of the ACE Geofence mobile application (&quot;the App&quot;), which is
      ...
      <div className="py-8 space-y-8">
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <p className="text-warp">
              ACE Geofence is an internal application developed for authorized
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <p className="text-warp">
              Use of the App is subject to the ACE Geofence Privacy Policy,
              which outlines how personal and location data may be collected and
              used for internal HR purposes. By using the App, you consent to
              the collection and processing of such data as described in the
              Privacy Policy.
            </p>
          </div>
        </div>
