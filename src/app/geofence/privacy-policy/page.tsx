...
export const metadata: Metadata = {
  title: "ACE Geofence - Privacy Policy",
  description: "ACE Geofence All in one SmartHR Service - Privacy Policy",
};
    ...
    <div className="px-6 lg:px-12 xl:px-24">
      ...
      <div className="space-y-4">
        <p className="text-wrap">
          ACE Geofence (hereinafter referred to as &quot;We&quot;) is designed
          to support internal HR operations by enabling employees to manage
          tasks such as attendance tracking, leave requests, payroll access, and
          other HR self-service functions. This application is intended for
          internal use by authorized employees only and is not available for
          public use. We are committed to protecting the privacy of our users.
        </p>
        <p>
      ...
      <div className="py-8 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <p className="text-warp">
              For any questions about this policy, please contact your ACE
              Geofence Support Team:
            </p>
            <p>ACE Geofence Support Team</p>
            <p>
              Email: &nbsp;
              <a
                className="border-b border-blue-500 text-blue-500 after:content-['_↗'] cursor-pointer"
                href="mailto:hradmin@acedatasystems.com"
              >
                hradmin@acedatasystems.com
              </a>
            </p>
            {/* <p>
